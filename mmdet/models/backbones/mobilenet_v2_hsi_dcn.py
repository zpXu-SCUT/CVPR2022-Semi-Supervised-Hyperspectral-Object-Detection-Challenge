...
class MobileNetV2HSIDCN(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MobileNetV2HSIDCN, self).__init__(init_cfg)
    ...
    def forward(self, x):
        ...
        for i, layer_name in enumerate(self.layers):
            ...
            dcn = self.dcn if i<7 and self.stage_with_dcn[i] else None
            layer.conv_cfg=dcn
            x = layer(x)
    ...
    def train(self, mode=True):
        ...
        frozen."""
        super(MobileNetV2HSIDCN, self).train(mode)
        self._freeze_stages()
